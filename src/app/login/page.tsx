        ...
        <div className="h-1/2 relative overflow-hidden">
          ...
          <div className="relative h-full flex items-center justify-center p-8">
            <img
              src="/logo-nor-vazado.png"
              alt="NOR Logistics"
              className="h-24 w-auto object-contain opacity-80 drop-shadow-2xl filter brightness-125"
            />
          </div>
        </div>

        {/* Bottom - Login Form */}
        <div className="h-1/2 flex items-center justify-center bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 px-4 py-8">
          <div className="max-w-sm w-full space-y-6">
            <div className="text-center">
              ...
              />
              <h1 className="mt-3 text-center text-xl font-bold text-white tracking-wider">
                NOR-LOGISTICS
              </h1>
            ...
            <div className="rounded-md shadow-sm -space-y-px">
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="appearance-none rounded-none relative block w-full px-3 py-3 border border-slate-600 bg-slate-800/50 placeholder-slate-400 text-white rounded-t-md focus:outline-none focus:ring-purple-500 focus:border-purple-500 focus:z-10 text-sm"
                  placeholder="Email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                />
              ...
              <div>
                ...
                <input
                  ...
                  autoComplete="current-password"
                  required
                  className="appearance-none rounded-none relative block w-full px-3 py-3 border border-slate-600 bg-slate-800/50 placeholder-slate-400 text-white rounded-b-md focus:outline-none focus:ring-purple-500 focus:border-purple-500 focus:z-10 text-sm"
                  placeholder="Senha"
                  value={password}
                  onChange={(e) => setPassword(e.target.value)}
                />
